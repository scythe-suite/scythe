...
export TM_SETTINGS="$CONFS_DIR/${SCYTHE_SESSION_ID}.py"
export ST_SETTINGS="$CONFS_DIR/${SCYTHE_SESSION_ID}-t.py"
...
export REMOTE_ENDPOINT="http://$SCYTHE_SERVER:8080/tm/$SCYTHE_TESTER_ID/$SCYTHE_SESSION_ID/"
